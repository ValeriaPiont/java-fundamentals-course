...
public class CrazyGenerics {
    ...
    static class CollectionUtil {
         ...
         * @param list
         */
        public static void print(List<?> list) { // method is static, we don't know which method will be used
        ...
        public static boolean hasNewEntities(Collection<? extends BaseEntity> entities) {
            return entities.stream()
                    .map(entity -> Optional.ofNullable(entity.getUuid()))
